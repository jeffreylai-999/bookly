#!/usr/bin/env node
/**
 * Runs supabase/tests/holds_lifecycle.sql against the local DB container.
 * Mirrors scripts/run-checkin-test.mjs.
 */
...
const sql = readFileSync('supabase/tests/holds_lifecycle.sql', 'utf8');
