#!/usr/bin/env node
/**
 * Runs supabase/tests/cron_jobs.sql against the local DB container.
 * Mirrors scripts/run-notifications-test.mjs.
 */
...
const sql = readFileSync('supabase/tests/cron_jobs.sql', 'utf8');
