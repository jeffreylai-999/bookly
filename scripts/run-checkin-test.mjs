#!/usr/bin/env node
/**
 * Runs supabase/tests/checkin.sql against the local DB container.
 * Mirrors scripts/run-checkout-gates-test.mjs.
 */
...
const sql = readFileSync('supabase/tests/checkin.sql', 'utf8');
