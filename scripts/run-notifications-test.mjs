#!/usr/bin/env node
/**
 * Runs supabase/tests/notifications.sql against the local DB container.
 * Mirrors scripts/run-fines-test.mjs.
 */
...
const sql = readFileSync('supabase/tests/notifications.sql', 'utf8');
